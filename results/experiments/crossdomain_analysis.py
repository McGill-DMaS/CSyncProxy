...
def main():
    crossdomainsfile = "test_crossdomains/0_1_0.01_0_paths_recurring_ids2.txt"
    cookiefile = "0_1_0.01_0_cookietest.txt"
    total_ids = id_extraction(crossdomainsfile)
    matches = search_through_cookies(cookiefile, total_ids)

    with open("../experiment_counts.txt", 'a', encoding='utf-8') as counts:
